...
DEF_CMD_(JAS,   40, fprintf(disasm, "JAS :%lg\n", cmds[j+1]); j = j + 2;)
DEF_CMD_(JAES,  41, fprintf(disasm, "JAES :%lg\n", cmds[j+1]); j = j + 2;)
DEF_CMD_(JBS,   42, fprintf(disasm, "JBS :%lg\n", cmds[j+1]); j = j + 2;)
DEF_CMD_(JBES,  43, fprintf(disasm, "JBES :%lg\n", cmds[j+1]); j = j + 2;)
DEF_CMD_(JNS,   44, fprintf(disasm, "JES :%lg\n", cmds[j+1]); j = j + 2;)
DEF_CMD_(JNES,  45, fprintf(disasm, "JNES :%lg\n", cmds[j+1]); j = j + 2;)
